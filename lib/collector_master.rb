    ...
    class CollectorMaster
        ...
        def assign_task
            begin
                ...
                logger.error("Error in assign task: #{e.message} #{e.backtrace}")
            end
        end
        ...
        def remove_dead_collector
            begin
                ...
                logger.error("Error in remove dead collector: #{e.message} #{e.backtrace}")
            end
        end
        def register_collector
            begin
                ...
                logger.error("Error in register collector: #{e.message} #{e.backtrace}")
            end
        end
        ...
        def check_task_assign
            begin
                ...
                logger.error("Error in check task assign: #{e.message} #{e.backtrace}")
            end
        end
